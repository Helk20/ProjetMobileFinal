...
public interface JsonPlaceHolderApi {
    ...
    @GET("/pharmacies/allJour")
    Call<List<Pharmacie>> findJour();


    @GET("/zones/alls")
    Call<List<Zone>> Zone();

    @GET("/pharmacies/allZone")
    Call<List<Pharmacie>> findZone();

    @GET("/pharmacies/allZone2")
    Call<List<Pharmacie>> findZone2();
}
